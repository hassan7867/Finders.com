...
@section('content')
    ...
    <div class="super_container">
        <div class="home" style="height: 340px !important;">
            <div>Properties</div>
        </div>
        </div>
        ...
        <div class="search">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="search_container" style="margin-top: -200px !important;">
                            <h3 class="text-center" style="color: black !important;"><b>Filter Properties</b></h3>
    ...
    {{--properties list--}}
    <div class="featured" id="properties" style="padding-top: 20px">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="section_title_container text-center">
                        <h3 style="color: black"><b>Search Results</b></h3>
                    ...
                    <div class="col-lg-4">
                        <div class="listing">
                            <div class="listing_image" style="cursor: pointer" onclick="viewDetails({{$property->id}})">
                                ...
                                <div class="tag_price listing_price">PKR {{$property->price}}</div>
                            </div>
